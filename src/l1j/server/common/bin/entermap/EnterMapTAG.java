			...
			for (ConditionsTAG tag : _Conditions) {
				...
				if (spellBuffs != null) {
					...
					for (SpellBuffTAG spellBuff : spellBuffs) {
						...
						sb.append(" & FAIL_HTML = ").append(spellBuff.get_FailHtml() == null ? "" : new String(spellBuff.get_FailHtml(), CharsetUtil.MS_950));
					}
					sb.append(")");
				}
				...
				if (spell != null) {
					...
					sb.append(" & FAIL_HTML = ").append(spell.get_FailHtml() == null ? "" : new String(spell.get_FailHtml(), CharsetUtil.MS_950));
					sb.append(")");
				}
