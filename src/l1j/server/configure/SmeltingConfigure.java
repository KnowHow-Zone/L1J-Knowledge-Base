	...
	public void load(){
		...
		try {
			...
			String alchemyUsedIds				= new String(setting.getProperty("SMELTING_ALCHEMY_USED_IDS",
												"1, 2, 3, 4, 5, 6")
												.getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			...
			String equipTypes 					= new String(setting.getProperty("SMELTING_EQUIP_TYPES", "2").getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			...
			String equipWeaponTypes 			= new String(setting.getProperty("SMELTING_EQUIP_WEAPON_TYPES", "0").getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			...
			String equipArmorTypes 				= new String(setting.getProperty("SMELTING_EQUIP_ARMOR_TYPES", "2").getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
