...
public class ServerConfigure {
	...
	public void load(){
		try {
			...
			GAME_SERVER_NAME				= new String(settings.getProperty("GAME_SERVER_NAME", "*").getBytes(CharsetUtil.ISO_8859_1_STR), CharsetUtil.BIG5_STR);
			...
			CREATE_IP_ACCOUNT_COUNT			= Integer.parseInt(settings.getProperty("CREATE_IP_ACCOUNT_COUNT", "10"));
			CREATE_HDD_ACCOUNT_COUNT		= Integer.parseInt(settings.getProperty("CREATE_HDD_ACCOUNT_COUNT", "10"));
			...
			IP_INFORMATION_API_KEY			= new String(settings.getProperty("IP_INFORMATION_API_KEY", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1_STR), CharsetUtil.BIG5_STR);
