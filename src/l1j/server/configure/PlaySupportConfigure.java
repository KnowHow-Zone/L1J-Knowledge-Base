...
public class PlaySupportConfigure {
	...
	public void load(){
		try {
			...
			PLAY_SUPPORT_BUCKET_NAME				= new String(settings.getProperty("PLAY_SUPPORT_BUCKET_NAME", "LIVE_LIN_PSSCONFIG_24003492").getBytes(CharsetUtil.ISO_8859_1_STR), CharsetUtil.BIG5_STR);
