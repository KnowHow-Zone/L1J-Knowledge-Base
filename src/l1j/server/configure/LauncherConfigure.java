...
public class LauncherConfigure {
	...
	public void load(){
		try {
			...
			CONNECTOR_ENCRYPT_KEY		= new String(settings.getProperty("CONNECTOR_ENCRYPT_KEY", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1_STR), CharsetUtil.BIG5_STR);
			CONNECTOR_SESSION_KEY		= new String(settings.getProperty("CONNECTOR_SESSION_KEY", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1_STR), CharsetUtil.BIG5_STR);
			...
			CONNECTOR_BROWSER_URL		= new String(settings.getProperty("CONNECTOR_BROWSER_URL", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_HOMPAGE_URL		= new String(settings.getProperty("CONNECTOR_HOMPAGE_URL", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_LINBIN_PATH		= new String(settings.getProperty("CONNECTOR_LINBIN_PATH", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_LINBIN_SIZE		= Integer.parseInt(settings.getProperty("CONNECTOR_LINBIN_SIZE", StringUtil.ZeroString));
			CONNECTOR_PATCH_PATH		= new String(settings.getProperty("CONNECTOR_PATCH_PATH", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_MSDLL_PATH		= new String(settings.getProperty("CONNECTOR_MSDLL_PATH", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_MSDLL_SIZE		= Integer.parseInt(settings.getProperty("CONNECTOR_MSDLL_SIZE", StringUtil.ZeroString));
			CONNECTOR_LIBCOCOS_PATH		= new String(settings.getProperty("CONNECTOR_LIBCOCOS_PATH", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_LIBCOCOS_SIZE		= Integer.parseInt(settings.getProperty("CONNECTOR_LIBCOCOS_SIZE", StringUtil.ZeroString));
			CONNECTOR_BOXDLL_PATH		= new String(settings.getProperty("CONNECTOR_BOXDLL_PATH", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_LOADER_PATH		= new String(settings.getProperty("CONNECTOR_LOADER_PATH", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_CRAFT_PATH		= new String(settings.getProperty("CONNECTOR_CRAFT_PATH", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_ENGINE_NAMES		= new String(settings.getProperty("CONNECTOR_ENGINE_NAMES", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			...
			CONNECTOR_CREATE_URI		= new String(settings.getProperty("CONNECTOR_CREATE_URI", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_LOGIN_URI			= new String(settings.getProperty("CONNECTOR_LOGIN_URI", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_LOGIN_MERGE_URI	= new String(settings.getProperty("CONNECTOR_LOGIN_MERGE_URI", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_ENGINE_URI		= new String(settings.getProperty("CONNECTOR_ENGINE_URI", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
			CONNECTOR_PROCESS_URI		= new String(settings.getProperty("CONNECTOR_PROCESS_URI", StringUtil.EmptyString).getBytes(CharsetUtil.ISO_8859_1), CharsetUtil.BIG5);
